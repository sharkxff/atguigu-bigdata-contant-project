...
public class MysqlBeanOutputFormat extends OutputFormat<OutputKey,OutputValue> {
    ...
    static class MysqlRecordWriter extends RecordWriter<OutputKey,OutputValue>{
    ...
    //写出记录
    public RecordWriter<OutputKey, OutputValue> getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
